...
!(function () {
  ...
  function it(t) {
    ...
    Q(n) &&
      ((y.transform =
        ((u = (c = { transform: n, startCentered: !0, width: r, height: a }).transform), (m = c.width), (d = void 0 === m ? C : m), (g = c.height), (h = void 0 === g ? C : g), (p = c.startCentered), (b = ""), (b += (v = void 0 !== p && p) && k ? "translate(" + (u.x / B - d / 2) + "em, " + (u.y / B - h / 2) + "em) " : v ? "translate(calc(-50% + " + u.x / B + "em), calc(-50% + " + u.y / B + "em)) " : "translate(" + u.x / B + "em, " + u.y / B + "em) "), (b += "scale(" + (u.size / B) * (u.flipX ? -1 : 1) + ", " + (u.size / B) * (u.flipY ? -1 : 1) + ") "), (b += "rotate(" + u.rotate + "deg) "))),
